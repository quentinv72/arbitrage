...
pub mod i_pancake_callee {
    const _: () = {
        ::core::include_bytes!(
            "/Users/quentin/arbitrage/contracts/src/json_abi/IPancakeCallee.sol/IPancakeCallee.json",
        );
    };
    #[allow(deprecated)]
    ...
    impl<M> ::core::ops::Deref for IPancakeCallee<M> {
        type Target = ::ethers::contract::Contract<M>;
        fn deref(&self) -> &Self::Target {
            &self.0
        }
    }
    impl<M> ::core::ops::DerefMut for IPancakeCallee<M> {
        fn deref_mut(&mut self) -> &mut Self::Target {
            &mut self.0
        }
    }
    impl<M> ::core::fmt::Debug for IPancakeCallee<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(::core::stringify!(IPancakeCallee))
                .field(&self.address())
                .finish()
        }
    }
