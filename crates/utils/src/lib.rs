...
pub static TOKEN_BLACKLIST: Lazy<HashSet<Address>> = Lazy::new(|| {
    ...
    set.insert(
        "0x6aA614B6FcDEC46f74cE86e74706ec4c815B3da0"
            .parse()
            .unwrap(),
    );
    ...
    set.insert(
        "0x9C061DF134d11412151E9c200ce3F9f6F295094a"
            .parse()
            .unwrap(),
    );
    set.insert(
        "0x378E8c47eb42cCE0dd9Cff48276a2aB73e9C254F"
            .parse()
            .unwrap(),
    );
    set.insert(
    ...
    set.insert(
        "0x966f2262aB963514cB0d4ec5721Af209879a1Fd9"
            .parse()
            .unwrap(),
    );
    set
