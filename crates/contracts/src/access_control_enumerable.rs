...
pub mod access_control_enumerable {
    ...
    impl ::core::convert::From<AccessControlBadConfirmation> for AccessControlEnumerableErrors {
        fn from(value: AccessControlBadConfirmation) -> Self {
            Self::AccessControlBadConfirmation(value)
        }
    }
    impl ::core::convert::From<AccessControlUnauthorizedAccount> for AccessControlEnumerableErrors {
