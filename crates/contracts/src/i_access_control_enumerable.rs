...
pub mod i_access_control_enumerable {
    ...
    impl ::core::convert::From<::std::string::String> for IAccessControlEnumerableErrors {
        fn from(value: String) -> Self {
            Self::RevertString(value)
        }
    }
    impl ::core::convert::From<AccessControlBadConfirmation> for IAccessControlEnumerableErrors {
        fn from(value: AccessControlBadConfirmation) -> Self {
            Self::AccessControlBadConfirmation(value)
        }
    }
    impl ::core::convert::From<AccessControlUnauthorizedAccount> for IAccessControlEnumerableErrors {
