pub use i_cro_defi_swap_callee::*;
...
pub mod i_cro_defi_swap_callee {
    ...
    pub static ICRODEFISWAPCALLEE_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> =
        ::ethers::contract::Lazy::new(__abi);
    pub struct ICroDefiSwapCallee<M>(::ethers::contract::Contract<M>);
    impl<M> ::core::clone::Clone for ICroDefiSwapCallee<M> {
        fn clone(&self) -> Self {
            Self(::core::clone::Clone::clone(&self.0))
        }
    }
    impl<M> ::core::ops::Deref for ICroDefiSwapCallee<M> {
        type Target = ::ethers::contract::Contract<M>;
        fn deref(&self) -> &Self::Target {
            &self.0
        }
    }
    impl<M> ::core::ops::DerefMut for ICroDefiSwapCallee<M> {
        fn deref_mut(&mut self) -> &mut Self::Target {
            &mut self.0
        }
    }
    impl<M> ::core::fmt::Debug for ICroDefiSwapCallee<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(::core::stringify!(ICroDefiSwapCallee))
                .field(&self.address())
                .finish()
        }
    }
    impl<M: ::ethers::providers::Middleware> ICroDefiSwapCallee<M> {
