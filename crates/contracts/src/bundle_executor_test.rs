...
pub mod bundle_executor_test {
        ...
        ::ethers::core::abi::ethabi::Contract {
            ...
            functions: ::core::convert::From::from([
                ...
                (
                    ...
                    ::std::vec![::ethers::core::abi::ethabi::Function {
                        name: ::std::borrow::ToOwned::to_owned("testNonAdminCannotGrantRoles",),
                        inputs: ::std::vec![],
                        outputs: ::std::vec![],
                        constant: ::core::option::Option::None,
                        state_mutability: ::ethers::core::abi::ethabi::StateMutability::NonPayable,
                ...
                (
                    ...
                    ::std::vec![::ethers::core::abi::ethabi::Function {
                        name: ::std::borrow::ToOwned::to_owned("testNonOwnerCannotWithdraw",),
                        inputs: ::std::vec![],
                        outputs: ::std::vec![],
                        constant: ::core::option::Option::None,
                        state_mutability: ::ethers::core::abi::ethabi::StateMutability::NonPayable,
                ...
                (
                    ...
                    ::std::vec![::ethers::core::abi::ethabi::Function {
                        name: ::std::borrow::ToOwned::to_owned("testOnlyOwnerWithdrawEth",),
                        inputs: ::std::vec![],
                        outputs: ::std::vec![],
                        constant: ::core::option::Option::None,
                        state_mutability: ::ethers::core::abi::ethabi::StateMutability::NonPayable,
                ...
                (
                    ...
                    ::std::vec![::ethers::core::abi::ethabi::Function {
                        name: ::std::borrow::ToOwned::to_owned("testOwnerCanAddToRoles",),
                        inputs: ::std::vec![],
                        outputs: ::std::vec![],
                        constant: ::core::option::Option::None,
                        state_mutability: ::ethers::core::abi::ethabi::StateMutability::NonPayable,
                ...
                (
                    ::std::borrow::ToOwned::to_owned("testUnauthorizedCallersCannotExecuteTrade"),
                    ::std::vec![::ethers::core::abi::ethabi::Function {
    ...
    pub static BUNDLEEXECUTORTEST_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> =
    ...
    pub static BUNDLEEXECUTORTEST_BYTECODE: ::ethers::core::types::Bytes =
    ...
    pub static BUNDLEEXECUTORTEST_DEPLOYED_BYTECODE: ::ethers::core::types::Bytes =
    ...
    impl<M: ::ethers::providers::Middleware> BundleExecutorTest<M> {
        ...
        pub fn test_executor_v_2to_v2(&self) -> ::ethers::contract::builders::ContractCall<M, ()> {
            self.0
                .method_hash([195, 81, 8, 242], ())
                .expect("method not found (this should never happen)")
        }
        ///Calls the contract's `testExecutorV2toV3` (0x7303d09a) function
        pub fn test_executor_v_2to_v3(&self) -> ::ethers::contract::builders::ContractCall<M, ()> {
            self.0
        ...
        pub fn events(
            &self,
        ) -> ::ethers::contract::builders::Event<::std::sync::Arc<M>, M, BundleExecutorTestEvents>
        {
            self.0
    ...
    #[ethcall(
        name = "testNonOwnerCannotWithdraw",
        abi = "testNonOwnerCannotWithdraw()"
    )]
    ...
    pub enum BundleExecutorTestCalls {
        ...
        TestUnauthorizedCallersCannotExecuteTrade(TestUnauthorizedCallersCannotExecuteTradeCall),
    }
    impl ::ethers::core::abi::AbiDecode for BundleExecutorTestCalls {
        fn decode(
            ...
            if let Ok(decoded) =
                <TestExecutorV2ToV2Call as ::ethers::core::abi::AbiDecode>::decode(data)
            {
                return Ok(Self::TestExecutorV2ToV2(decoded));
            }
            if let Ok(decoded) =
                <TestExecutorV2ToV3Call as ::ethers::core::abi::AbiDecode>::decode(data)
            {
                return Ok(Self::TestExecutorV2ToV3(decoded));
            }
            if let Ok(decoded) =
                <TestNonAdminCannotGrantRolesCall as ::ethers::core::abi::AbiDecode>::decode(data)
            {
                return Ok(Self::TestNonAdminCannotGrantRoles(decoded));
            }
            if let Ok(decoded) =
                <TestNonOwnerCannotWithdrawCall as ::ethers::core::abi::AbiDecode>::decode(data)
            {
                return Ok(Self::TestNonOwnerCannotWithdraw(decoded));
            }
            if let Ok(decoded) =
                <TestOnlyOwnerWithdrawEthCall as ::ethers::core::abi::AbiDecode>::decode(data)
            {
                return Ok(Self::TestOnlyOwnerWithdrawEth(decoded));
            }
            if let Ok(decoded) =
                <TestOwnerCanAddToRolesCall as ::ethers::core::abi::AbiDecode>::decode(data)
            {
    ...
    impl ::core::fmt::Display for BundleExecutorTestCalls {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
                ...
                Self::TestExecutorV2ToV2(element) => ::core::fmt::Display::fmt(element, f),
                Self::TestExecutorV2ToV3(element) => ::core::fmt::Display::fmt(element, f),
                Self::TestNonAdminCannotGrantRoles(element) => {
                    ::core::fmt::Display::fmt(element, f)
                }
                Self::TestNonOwnerCannotWithdraw(element) => ::core::fmt::Display::fmt(element, f),
                Self::TestOnlyOwnerWithdrawEth(element) => ::core::fmt::Display::fmt(element, f),
                Self::TestOwnerCanAddToRoles(element) => ::core::fmt::Display::fmt(element, f),
                Self::TestUnauthorizedCallersCannotExecuteTrade(element) => {
                    ::core::fmt::Display::fmt(element, f)
                }
            }
    ...
    impl ::core::convert::From<TestNonAdminCannotGrantRolesCall> for BundleExecutorTestCalls {
        fn from(value: TestNonAdminCannotGrantRolesCall) -> Self {
            Self::TestNonAdminCannotGrantRoles(value)
        }
    }
    impl ::core::convert::From<TestNonOwnerCannotWithdrawCall> for BundleExecutorTestCalls {
        fn from(value: TestNonOwnerCannotWithdrawCall) -> Self {
            Self::TestNonOwnerCannotWithdraw(value)
        }
    }
    impl ::core::convert::From<TestOnlyOwnerWithdrawEthCall> for BundleExecutorTestCalls {
